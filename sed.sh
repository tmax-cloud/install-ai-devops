...
sed -i "s/image: \"docker.io\/istio\/proxyv2/image: \"${registry}\/docker.io\/istio\/proxyv2/g" ${dir}/istio-1-3-1\/cluster-local-gateway\/base\/deployment.yaml
...
sed -i "s/\"image\": \"docker.io\/kubeflowkatib\/file-metrics-collector/\"image\": \"${registry}\/docker.io\/kubeflowkatib\/file-metrics-collector/g" ${dir}/katib\/katib-controller\/base\/katib-configmap.yaml
sed -i "s/\"image\": \"docker.io\/kubeflowkatib\/tfevent-metrics-collector/\"image\": \"${registry}\/docker.io\/kubeflowkatib\/tfevent-metrics-collector/g" ${dir}/katib\/katib-controller\/base\/katib-configmap.yaml
sed -i "s/\"image\": \"docker.io\/kubeflowkatib\/suggestion-hyperopt/\"image\": \"${registry}\/docker.io\/kubeflowkatib\/suggestion-hyperopt/g" ${dir}/katib\/katib-controller\/base\/katib-configmap.yaml
sed -i "s/\"image\": \"docker.io\/kubeflowkatib\/suggestion-chocolate/\"image\": \"${registry}\/docker.io\/kubeflowkatib\/suggestion-chocolate/g" ${dir}/katib\/katib-controller\/base\/katib-configmap.yaml
sed -i "s/\"image\": \"docker.io\/kubeflowkatib\/suggestion-hyperband/\"image\": \"${registry}\/docker.io\/kubeflowkatib\/suggestion-hyperband/g" ${dir}/katib\/katib-controller\/base\/katib-configmap.yaml
sed -i "s/\"image\": \"docker.io\/kubeflowkatib\/suggestion-skopt/\"image\": \"${registry}\/docker.io\/kubeflowkatib\/suggestion-skopt/g" ${dir}/katib\/katib-controller\/base\/katib-configmap.yaml
sed -i "s/\"image\": \"docker.io\/kubeflowkatib\/suggestion-goptuna/\"image\": \"${registry}\/docker.io\/kubeflowkatib\/suggestion-goptuna/g" ${dir}/katib\/katib-controller\/base\/katib-configmap.yaml
sed -i "s/\"image\": \"docker.io\/kubeflowkatib\/suggestion-enas/\"image\": \"${registry}\/docker.io\/kubeflowkatib\/suggestion-enas/g" ${dir}/katib\/katib-controller\/base\/katib-configmap.yaml
sed -i "s/\"image\": \"docker.io\/kubeflowkatib\/suggestion-darts/\"image\": \"${registry}\/docker.io\/kubeflowkatib\/suggestion-darts/g" ${dir}/katib\/katib-controller\/base\/katib-configmap.yaml
sed -i "s/\"image\": \"docker.io\/kubeflowkatib\/earlystopping-medianstop/\"image\": \"${registry}\/docker.io\/kubeflowkatib\/earlystopping-medianstop/g" ${dir}/katib\/katib-controller\/base\/katib-configmap.yaml
sed -i "s/newName: docker.io\/kubeflowkatib\/katib-controller/newName: ${registry}\/docker.io\/kubeflowkatib\/katib-controller/g" ${dir}/katib/katib-controller/base/kustomization.yaml
sed -i "s/newName: docker.io\/kubeflowkatib\/katib-db-manager/newName: ${registry}\/docker.io\/kubeflowkatib\/katib-db-manager/g" ${dir}/katib/katib-controller/base/kustomization.yaml
sed -i "s/newName: docker.io\/kubeflowkatib\/katib-ui/newName: ${registry}\/docker.io\/kubeflowkatib\/katib-ui/g" ${dir}/katib/katib-controller/base/kustomization.yaml
sed -i "s/newName: docker.io\/kubeflowkatib\/cert-generator/newName: ${registry}\/docker.io\/kubeflowkatib\/cert-generator/g" ${dir}/katib/katib-controller/base/kustomization.yaml
sed -i "s/newName: mysql/newName: ${registry}\/mysql/g" ${dir}/katib/katib-controller/base/kustomization.yaml
sed -i "s/newName: mysql/newName: ${registry}\/mysql/g" ${dir}/katib/katib-controller/overlays/ibm-storage-config/kustomization.yaml
sed -i "s/image: docker.io\/kubeflowkatib\/mxnet-mnist/image: ${registry}\/docker.io\/kubeflowkatib\/mxnet-mnist/g" ${dir}/katib\/katib-controller\/base\/trial-template-configmap.yaml
sed -i "s/image: docker.io\/kubeflowkatib\/enas-cnn-cifar10-cpu/image: ${registry}\/docker.io\/kubeflowkatib\/enas-cnn-cifar10-cpu/g" ${dir}/katib\/katib-controller\/base\/trial-template-configmap.yaml
sed -i "s/image: docker.io\/kubeflowkatib\/pytorch-mnist/image: ${registry}\/docker.io\/kubeflowkatib\/pytorch-mnist/g" ${dir}/katib\/katib-controller\/base\/trial-template-configmap.yaml
